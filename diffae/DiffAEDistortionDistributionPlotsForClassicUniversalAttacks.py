...
attack_types = ["la_l2_kfAdamNoScheduler1", "la_wass_kfAdamNoScheduler1", "latent_SKL", "la_cos_kfAdamNoScheduler1", "grill_l2_kfAdamNoScheduler1", "grill_wass_kfAdamNoScheduler1", "combi_SKL", "grill_cos_kfAdamNoScheduler1"]
...
plt.show()
plt.savefig("diffae/grill_damage_distributions_variation/diffAE_bp.png")
