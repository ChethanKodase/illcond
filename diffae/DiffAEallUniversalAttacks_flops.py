...
cd illcond
conda activate dt2
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.5 --attck_type la_l2_kfAdamNoScheduler1 --which_gpu 5 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.18 --attck_type la_wass_kfAdamNoScheduler1 --which_gpu 3 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.18 --attck_type la_cos_kfAdamNoScheduler1 --which_gpu 4 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.18 --attck_type grill_l2_kfAdamNoScheduler1 --which_gpu 6 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.18 --attck_type grill_wass_kfAdamNoScheduler1 --which_gpu 2 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad
python diffae/DiffAEallUniversalAttacks_flops.py --desired_norm_l_inf 0.18 --attck_type grill_cos_kfAdamNoScheduler1 --which_gpu 7 --diffae_checkpoint diffae/checkpoints --ffhq_images_directory diffae/imgs_align_uni_ad


difffae: 

la (l2, wass, cos) : 139965137154

grill (l2, wass, coss) 139965137728
