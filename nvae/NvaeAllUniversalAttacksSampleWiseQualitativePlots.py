...
for ch in range(15):
    ...
    with torch.no_grad():
        ...
        plt.show()
        plt.show()
        plt.savefig("nvae/universal_qualitative/paperInd_"+str(ch)+"_universal_NVAE_attacks_norm_bound_"+str(desired_norm_l_inf)+"feature_"+str(select_feature_dd)+"_source_segment_.png", bbox_inches='tight')
        plt.close()
