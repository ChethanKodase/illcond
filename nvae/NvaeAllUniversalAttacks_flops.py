...
cd ..
cd illcond/
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "la_l2_kf" --desired_norm_l_inf 0.0001 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "la_wass_kf_cr" --desired_norm_l_inf 0.037 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "la_cos_kf_cr" --desired_norm_l_inf 0.037 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "grill_l2_kf" --desired_norm_l_inf 0.037 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "grill_wass_kf" --desired_norm_l_inf 0.05 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks_flops.py --attck_type "grill_cos_kf" --desired_norm_l_inf 0.09 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint


NVAE
Flops count: 
la_l2_kf : 173084638329
la_wass_kf_cr: 173086014409
173086953808 : 173086953808

grill_l2_kf : 173084164228
grill_wass_kf : 173253730263
