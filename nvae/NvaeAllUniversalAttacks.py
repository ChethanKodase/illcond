...
cd ..
cd illcond/
python nvae/NvaeAllUniversalAttacks.py --attck_type "la_l2_kf_layerLosses" --desired_norm_l_inf 0.05 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks.py --attck_type "grill_wass_kf_layerLosses" --desired_norm_l_inf 0.05 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
python nvae/NvaeAllUniversalAttacks.py --attck_type "grill_l2_kf_layerLosses" --desired_norm_l_inf 0.05 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
...
cd ..
cd illcond/
python nvae/NvaeAllUniversalAttacks.py --attck_type "grill_wass_kf_cr" --desired_norm_l_inf 0.025 --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
