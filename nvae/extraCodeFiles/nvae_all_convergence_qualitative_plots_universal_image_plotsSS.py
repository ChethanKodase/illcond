...
cd ..
cd alma/
python nvae/nvae_all_convergence_qualitative_plots_universal_image_plotsSS.py --data_directory ../data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint --uni_noise_path ../NVAE/attack_run_time_univ/attack_noise --desired_norm_l_inf 0.05
...
for ch in range(15):
    ...
    with torch.no_grad():
        ...
        plt.show()
        plt.show()
        plt.savefig("SSqualitative/paperInd_"+str(ch)+"_universal_NVAE_attacks_norm_bound_"+str(desired_norm_l_inf)+"feature_"+str(select_feature_dd)+"_source_segment_.png", bbox_inches='tight')
        plt.close()
