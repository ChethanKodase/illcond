...
cd illcond
conda activate mae5
python mae/MaeUniversalAttack.py --attck_type "la_cos_kf" --desired_norm_l_inf 0.5 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "la_l2_kf" --desired_norm_l_inf 0.1 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "la_wass_kf" --desired_norm_l_inf 0.08 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "lgr_l2_kf" --desired_norm_l_inf 0.05 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "lgr_cos_kf" --desired_norm_l_inf 0.05 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "lgr_wass_kf" --desired_norm_l_inf 0.05 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "oa_cos_kf" --desired_norm_l_inf 0.1 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "oa_wass_kf" --desired_norm_l_inf 0.08 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "oa_l2_kf" --desired_norm_l_inf 0.09 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "grill_cos_kf_only_decodings" --desired_norm_l_inf 0.1 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "grill_wass_kf_only_decodings" --desired_norm_l_inf 0.08 --set_mask_ratio 0.75 --learningRate 0.01
python mae/MaeUniversalAttack.py --attck_type "grill_l2_kf_only_decodings" --desired_norm_l_inf 0.1 --set_mask_ratio 0.75 --learningRate 0.01
...
cd mae/demo
conda activate mae5
python mae/MaeUniversalAttack.py --attck_type "grill_l2_kf_only_decodings_mcmc" --desired_norm_l_inf 0.07 --set_mask_ratio 0.75 --learningRate 0.01
...
# Actual allAttacktypes = ["la_l2_kf", "la_wass_kf", "la_cos_kf", "oa_l2_kf", "oa_wass_kf", "oa_cos_kf", "lgr_l2_kf", "lgr_wass_kf", "lgr_cos_kf", "grill_l2_kf_only_decodings", "grill_wass_kf_only_decodings", "grill_cos_kf_only_decodings"]
...
if attck_type == "grill_cos_kf_only_decodings":
    all_condition_nums = np.array(conditionNumberList)
    #print("before all_condition_nums.max(), all_condition_nums.max()", all_condition_nums.max(), all_condition_nums.min())
    all_condition_nums[all_condition_nums>100.0]=100
    cond_cmpli = (all_condition_nums.max() - all_condition_nums) + 1e-6
...
if attck_type == "grill_l2_kf_only_decodings":
    all_condition_nums = np.array(conditionNumberList)
    #print("before all_condition_nums.max(), all_condition_nums.max()", all_condition_nums.max(), all_condition_nums.min())
    all_condition_nums[all_condition_nums>100.0]=100
    cond_cmpli = (all_condition_nums.max() - all_condition_nums) + 1e-6
...
if attck_type == "grill_wass_kf_only_decodings":
    all_condition_nums = np.array(conditionNumberList)
    #print("before all_condition_nums.max(), all_condition_nums.max()", all_condition_nums.max(), all_condition_nums.min())
    all_condition_nums[all_condition_nums>100.0]=100
    cond_cmpli = (all_condition_nums.max() - all_condition_nums) + 1e-6
