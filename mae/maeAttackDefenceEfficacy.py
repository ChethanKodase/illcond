...
cd mae/demo
conda activate mae5
python maeAttack_mcmc.py --attck_type "oa_l2_kf_mcmc" --desired_norm_l_inf 0.09 --set_mask_ratio 0.75 --learningRate 0.01
...
cd mae/demo
conda activate mae5
python maeAttack_mcmc.py --attck_type "grill_cos_kf_only_decodings_mcmc" --desired_norm_l_inf 0.09 --set_mask_ratio 0.75 --learningRate 0.01
...
if attck_type == "grill_cos_kf_only_decodings_mcmc":
    ...
    for step in range(100):
        ...
        with torch.no_grad():
            ...
            if(updateQuest):
                all_adv_div_list.append(deviation.item())
                torch.save(noise_addition, "../univ_attack_storage/MAE_attack_type"+str(attck_type)+"_norm_bound_"+str(desired_norm_l_inf)+"_.pt")
                print("adv_div_list", all_adv_div_list)
                np.save("../deviation_store/MAE_attack_type"+str(attck_type)+"_norm_bound_"+str(desired_norm_l_inf)+"_.npy", all_adv_div_list)
